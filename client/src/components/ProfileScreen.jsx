...
//         {/* ===== WISHLIST LINK (NEW) ===== */}
//         <Link to="/wishlist" style={styles.wishlist}>
//           <span style={styles.wishlistIcon}>❤️</span>
//           <span style={styles.wishlistText}>Wishlist</span>
//         </Link>
...
//   .dropdown-signout:hover { background-color: #f0f0f0 !important; }
//   .logo-container:hover { border: 1px solid white; padding: 3px 7px !important; }
//   .account-container:hover { border: 1px solid white; padding: 3px 7px !important; }
//   .nav-link:hover { border: 1px solid white; padding: 3px 7px; }
//   .all-button:hover { border: 1px solid white; padding: 3px 7px; }
//   .search-button:hover { background-color: #f3a847 !important; }
//   .wishlist:hover { border: 1px solid white; padding: 3px 7px !important; }
// `;
